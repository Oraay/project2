...
@section('title','Ula petshop | Keranjang')
@section('content')
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="shoping__checkout">
                        ...
                        <ul>
                            <li>Subtotal <span>Rp.454.980</span></li>
                            <li>Total <span>Rp.454.980</span></li>
                        </ul>
                        <a href="/order/checkout" class="primary-btn">CHECKOUT</a>
                    </div>
                </div>
            </div>
        </div>
